...
def main(params):
  ...
  type=str, default="/content/drive/MyDrive/Fifth year/ClearBox/Diffusion_model_training/Cifar100_model/checkpoints", help='')
  ...
  dataset_train = CIFAR10("/content/CIFAR100", download=True, train=True,transform=transforms)
...
if __name__ == "__main__": 
  main(["--device", "cuda",
        "--batch_size", "8",
        "--checkpoint_directory", "/content/drive/MyDrive/Diffusion_model_training/Cifar100_model/checkpoints"])
